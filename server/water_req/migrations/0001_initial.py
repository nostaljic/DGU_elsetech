# Generated by Django 3.2.2 on 2021-06-01 23:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('request_date', models.CharField(max_length=32, primary_key=True, serialize=False, unique=True, verbose_name='요청날짜')),
                ...
                ('start_date', models.CharField(max_length=32, null=True, verbose_name='시작 날짜')),
                ('end_date', models.CharField(max_length=32, null=True, verbose_name='종료 날짜')),
                ('num_people', models.IntegerField(null=True, verbose_name='사용 인원')),
                ('usage', models.FloatField(null=True, verbose_name='사용 유량')),
