    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_ph', models.FloatField(default=6.907, verbose_name='공공데이터_pH')),
                ('public_rc', models.FloatField(default=0.263, verbose_name='공공데이터_잔류염소')),
                ('public_tb', models.FloatField(default=0.068, verbose_name='공공데이터_탁도')),
